...
/**
 * BeanMapHandler中的构造函数是私有的,所以自己实现
 *
 * @see org.apache.commons.dbutils.handlers.BeanMapHandler
 */
public class GenerousBeanMapHandler<K, V> extends AbstractKeyedHandler<K, V> {
    /**
     ...
     */
    public GenerousBeanMapHandler(Class<V> type, RowProcessor convert,
