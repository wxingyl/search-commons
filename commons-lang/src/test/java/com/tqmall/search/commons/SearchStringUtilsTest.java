...
public class SearchStringUtilsTest {
    ...
    public void joinTest() {
        ...
        String str = SearchStringUtils.join(list, CommonsConst.SEPARATOR_CHAR);
        Assert.assertEquals(str, "1,2,1");

        list.add(null);
        System.out.println("list: " + list);
        str = SearchStringUtils.join(list, CommonsConst.SEPARATOR_CHAR);
        Assert.assertEquals(str, "1,2,1,");
        ...
        str = SearchStringUtils.join(array, CommonsConst.SEPARATOR_CHAR);
        Assert.assertEquals(str, ",1,2,1,");
    ...
    public void splitTest() {
        String str = null;
        String[] array = SearchStringUtils.split(str, CommonsConst.SEPARATOR_CHAR);
        Assert.assertArrayEquals(null, array);

        str = "";
        array = SearchStringUtils.split(str, CommonsConst.SEPARATOR_CHAR);
